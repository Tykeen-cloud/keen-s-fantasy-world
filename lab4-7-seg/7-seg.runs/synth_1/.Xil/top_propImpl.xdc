set_property SRC_FILE_INFO {cfile:F:/7-seg/7-seg.srcs/constrs_1/new/pin.xdc rfile:../../../7-seg.srcs/constrs_1/new/pin.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports en];
set_property src_info {type:XDC file:1 line:4 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN P5  IOSTANDARD LVCMOS33 } [get_ports s3];
set_property src_info {type:XDC file:1 line:5 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN P1  IOSTANDARD LVCMOS33 } [get_ports control];
