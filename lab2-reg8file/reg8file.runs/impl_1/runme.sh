...
HD_PWD='F:/reg8file/reg8file.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg8file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg8file.tcl -notrace
