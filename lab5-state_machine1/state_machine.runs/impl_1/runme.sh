...
HD_PWD='F:/state_machine1/state_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log string_send.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source string_send.tcl -notrace
