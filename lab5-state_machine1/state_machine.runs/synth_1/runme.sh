...
HD_PWD='F:/state_machine1/state_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log string_send.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source string_send.tcl
