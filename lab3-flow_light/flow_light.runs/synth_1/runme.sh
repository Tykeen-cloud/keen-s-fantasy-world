...
HD_PWD='F:/flow_light/flow_light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flow_light.tcl
