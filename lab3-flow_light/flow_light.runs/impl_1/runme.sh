...
HD_PWD='F:/flow_light/flow_light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flow_light.tcl -notrace
